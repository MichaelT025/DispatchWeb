...
export const en = {
	...
	todoRunTasks: "Tasks this run",
	todoLastRun: "Last run",
	todoViewAll: "View all",
	todoSessionTasks: "Session todos",
	...
	newWorktreeChat: "New chat in a fresh worktree",
	worktreeToggle: "Worktree",
	worktreeToggleTip: "Run this chat in its own git worktree so its edits never touch the main checkout",
	worktreeNamePlaceholder: "branch name (blank = auto)",
	worktreeNameLabel: "Worktree branch name",
	worktreeCreate: "Create",
	worktreeCreating: "Creating worktree…",
	removeWorktree: "Remove worktree {branch} (branch is kept)",
	removeWorktreeConfirm: "Confirm remove worktree",
	removeWorktreeDirtyConfirm:
		"Worktree {branch} has uncommitted changes. Remove it anyway? Those changes will be lost (the branch and its commits are kept).",
...
/** Looks up a UI string and interpolates `{var}` placeholders. */
